...
Planning to spend sometime to work on custom views that contain a composition of component that need to depend on a some state before/and/or after some calls to different API endpoints 
